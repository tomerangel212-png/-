...
const HITSTER_OFFLINE = [
  ...
  "./hitster-kfar-bloom-2026-demo.js?v=20260820-ios-audio",
...
const CORE = [
  ...
  "./hitster-kfar-bloom-2026-demo.html","./hitster-kfar-bloom-2026-demo.js","./hitster-kfar-bloom-2026-demo.js?v=20260820-ios-audio","./hitster-hebrew-alist-888.json",
...
self.addEventListener("fetch",event=>{if(event.request.method!=="GET")return;const url=new URL(event.request.url);const sameOrigin=url.origin===self.location.origin;if(sameOrigin)event.respondWith(networkFirst(event.request));});
