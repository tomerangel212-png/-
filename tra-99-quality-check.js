...
check("HITSTER starts a card without waiting for preview", hitster.includes("function findPlayablePick") && hitster.includes("function nextRandomPick()") && hitster.includes("state.nextPick || nextRandomPick()") && hitster.includes("fetchPreviewForCurrent") && hitster.includes("state.unplayable.add") && hitster.includes("score >= 9"));
