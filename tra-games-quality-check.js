...
const checks = [
  ...
  {name:"Chess legality is delegated to chess.js",pass:gamesJs.includes("chess.js@1.4.0")&&gamesJs.includes("strictLegalMove")&&gamesJs.includes("commitStrictLegalMove")&&gamesJs.includes("game.moves({square")},
  ...
  {name:"Illegal king movement regression tests exist",pass:gamesJs.includes("king cannot move into rook check")&&gamesJs.includes("king cannot stay in check")&&gamesJs.includes("king cannot capture protected piece")&&gamesJs.includes("king cannot capture queen protected by bishop")&&gamesJs.includes("pinned defender still protects king destination")&&gamesJs.includes("kings cannot become adjacent")&&gamesJs.includes("castle through check blocked")},
  {name:"Special chess rules are regression-tested",pass:gamesJs.includes("en passant available immediately")&&gamesJs.includes("en passant expires after the immediate reply")&&gamesJs.includes("en passant cannot expose own king")&&gamesJs.includes("pinned piece cannot expose king")&&gamesJs.includes("promotion exposes queen rook bishop knight")&&gamesJs.includes("fifty move rule is claimable")&&gamesJs.includes("seventy five move rule is automatic")&&gamesJs.includes("threefold repetition is claimable")&&gamesJs.includes("fivefold repetition is automatic")&&gamesHtml.includes('id="claim-draw"')},
